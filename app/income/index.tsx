...
import { INCOME_CATEGORIES, CATEGORY_ICONS, CATEGORY_NAMES } from '@/lib/constants/categories';
...
export default function AddIncomeScreen() {
  ...
  const [selectedCategory, setSelectedCategory] = useState<TransactionCategory>('salary');
